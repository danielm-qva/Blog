            ...
            <div className="container mx-auto">
              {
                loading  ? (
                  <div role="status">
                  <svg aria-hidden="true" className="w-11 h-11 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                : 
                  ...
                  <Post desc={item.description} title="homa" imgurl={item.photoPost} key={index}/>
                )
              }
            </div>
      </div>
